/****************************************************************************
** Meta object code from reading C++ file 'pose_subscriber.h'
**
...
#include <memory>
#include "../../../ros2/header/pose_subscriber.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'pose_subscriber.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 24, 34), // "nav_msgs::msg::Odometry::Shar..."
QT_MOC_LITERAL(4, 59, 3) // "msg"

    },
    "Subscriber\0logReceived\0\0"
...
void Subscriber::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->logReceived((*reinterpret_cast< const nav_msgs::msg::Odometry::SharedPtr(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Subscriber::*)(const nav_msgs::msg::Odometry::SharedPtr );
...
// SIGNAL 0
void Subscriber::logReceived(const nav_msgs::msg::Odometry::SharedPtr _t1)
{
