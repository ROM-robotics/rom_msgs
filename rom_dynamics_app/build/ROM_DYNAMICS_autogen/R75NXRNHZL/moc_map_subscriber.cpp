...
QT_MOC_LITERAL(5, 69, 8) // "testEmit"
...
void MapSubscriber::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MapSubscriber::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MapSubscriber::testEmit)) {
                *result = 1;
                return;
            }
        }
